"""
Schema validation utilities for the Agentic Graph RAG system.

Provides validators for:
- Schema definition validation
- Structured data validation against schemas
- Unstructured data format validation
...
class StructuredDataValidator:
    """
    Validates structured data against schema definitions.
    
    Ensures that node/edge structured data conforms to the
    attribute definitions in their associated schema.
    """
    ...
    def validate_structured_data(
        ...
        """
        Validate structured data against a schema definition.
        ...
        Returns:
            Tuple of (is_valid, error_message, coerced_data)
        """
...
class UnstructuredDataValidator:
    """Validates unstructured data format (blobs and chunks)."""
    
    @staticmethod
    def validate_blob_format(blob: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
        """
        Validate that a blob has the correct format.
    ...
    def validate_chunk_format(chunk: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
        """
        Validate chunk metadata format.
    ...
    def validate_unstructured_data(
        ...
        """Validate a list of unstructured blobs."""
...
class VectorValidator:
    ...
    def validate_vector_config(
        ...
        """
        Validate vector configuration in schema.
...
class SchemaVersionValidator:
    ...
    def is_compatible(
        ...
        - Minor version changes: backward compatible (if allowed)
        - Patch version changes: fully compatible (if allowed)
        """
        try:
